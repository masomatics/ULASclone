...
class Shift_cifar():
    ...
    def __init__(
        ...
        alldat = datasets.CIFAR100(root=root, train=train, download=False)
    ...
    def __getitem__(self, i):
        ...
        #     images = deform_batch(images, scale=20,  dtype = 'linear', format = 'fullframe', fov = self.fov, pfov =self.pfov) 
