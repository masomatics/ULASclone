...
if __name__ == '__main__':
    ...
    parser.add_argument('--target', type=str, default='others')
    ...
    with open(args.shell_path, "w") as eval_script:
        ...
        for k in range(len(folder_list)):
            ...
            base_eval_command = f"""python ./analysis/classification_analysis.py \
--targdir={targdir} \
--target={args.target} \
...
--batchsize={args.batchsize}"""
            ...
            if args.mode == 'pfkube':
                jobname = gsh.dirname_to_jobname(args.jobname)
